...
| [`usage`](#usage)                     | `package`, `version`, `knownVersion`         | A version's _real_ public API, and what changed since the one you know |
...
Pass the version your model _thinks_ it knows and get the delta to the version
