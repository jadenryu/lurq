...
_established_: a successful co-install is positive proof two versions coexist, a
...
only each result's _position_ in its list. That's deliberate: it means two
