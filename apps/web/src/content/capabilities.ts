...
export const capabilities: Capability[] = [
  {
    ...
    icon: Search,
    title: "Recommend",
    body: "Ask in plain language. Get a short ranked list of what the market offers today.",
    lines: [
  ...
  },
  {
    ...
    icon: ScanLine,
    title: "Verify",
    body: "Due diligence before the purchase, not after the build breaks.",
    lines: [
  ...
  },
  {
    ...
    icon: Boxes,
    title: "Plan",
    body: "Source every slot in the stack, and make sure the pieces fit.",
    lines: [
  ...
  },
  {
    ...
    icon: GitCompare,
    title: "Compare",
    body: "Put competing suppliers side by side on what actually matters.",
    lines: [
