    ...
    upgrades: [
      {
        ...
        toVersion: "8.1.0",
        declaredIn: [
          { path: "package.json", range: "^6.4.0" },
          { path: "packages/admin/package.json", range: "^6.9.0" },
        ],
        hops: [
          {
            fromVersion: "6.9.2",
            toVersion: "7.4.1",
            verdict: "removes-exports" as const,
            removed: ["useHistory", "Switch", "Redirect", "withRouter"],
            arityChanged: [],
          },
          {
            fromVersion: "7.4.1",
            toVersion: "8.1.0",
            verdict: "removes-exports" as const,
            removed: ["useRouteMatch", "StaticRouter"],
      ...
      },
      {
        ...
        fromVersion: "2.7.0",
        toVersion: "4.0.1",
        declaredIn: [{ path: "package.json", range: "^2.6.7" }],
        hops: [
          {
            fromVersion: "2.7.0",
            toVersion: "3.3.2",
      ...
      {
        package: "express",
        declaredIn: [{ path: "package.json", range: "^4.18.2" }],
        fromVersion: "4.21.2",
        toVersion: "5.2.1",
        majorsBehind: 1,
        advisories: 0,
      ...
      {
        package: "date-fns",
        declaredIn: [{ path: "package.json", range: "^2.30.0" }],
        fromVersion: "2.30.0",
        toVersion: "4.1.0",
        majorsBehind: 2,
        advisories: 0,
      ...
      {
        package: "zod",
        declaredIn: [{ path: "package.json", range: "^3.23.8" }],
        fromVersion: "3.25.76",
        toVersion: "4.1.5",
        majorsBehind: 1,
        advisories: 0,
