...
export function CapabilityGrid() {
  // Same rule as every reveal on the page, including why the threshold is 0 and
  // why "above the viewport" counts as reached: see lib/use-reveal-once.ts.
  const { ref, played } = useRevealOnce<HTMLDivElement>("0px 0px -10% 0px");
