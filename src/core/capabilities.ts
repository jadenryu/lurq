...
export const CAPABILITIES: Capability[] = [
  ...
  },
  {
    ...
    question:
      'Will this MCP server work in Claude, ChatGPT, Cursor or VS Code, and what does it need?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Call volume by tool and by day, plus the outcomes agents reported back about the packages they chose.',
